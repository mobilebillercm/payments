...
use PhpAmqpLib\Connection\AMQPStreamConnection;
    ...
    list($queue_name, ,) = $channel->queue_declare(
        parse_ini_file("global-var-config.ini", true)['QUEUES']['PAYEMENT_PAYMENT_WITH_MOBILE_BILLER_ACCOUNT_ACCEPTED_QUEUE'],
        false,
        true,
        false,
        false);
    ...
    echo " [*] Waiting for payement with mobile biller credit acount to be accepted to exit press CTRL+C\n";
    ...
    $callback = function ($msg) {
        ...
        try {
            ...
            $url = parse_ini_file("global-var-config.ini", true)['URLS']['HOST_PAYMENTS'] . '/api/payments-from-mobile-biller-credit-account-accepted';
