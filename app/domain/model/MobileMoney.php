...
class MobileMoney extends Model
{
    ...
    protected $fillable = ['b_id', 'phonenumber', 'country_code', 'country_dialing_code','holder', 'issuer', 'active', 'user', 'created_at', 'updated_at'];

    public function __construct($b_id = null, $phonenumber = null, $country_code = null, $country_dialing_code = null,
                                $holder = null, $issuer = null, $active = null, User $user = null,  array $attributes = [])
    {
